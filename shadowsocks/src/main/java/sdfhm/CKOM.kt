 ...
 */
class CKOM(
    private val service: CKON.Interface, profileName: String,
...
//        .setContentIntent(CKOJ.configureIntent(service))
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (service.data.state == CKON.State.Connected) updateCallback(intent.action == Intent.ACTION_SCREEN_ON)
    }
