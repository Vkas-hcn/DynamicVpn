...
class CKOQ(private val resolver: suspend (ByteArray) -> ByteArray) : ConcurrentLocalSocketListener(
        "LocalDnsThread", File(CKOJ.deviceStorage.noBackupFilesDir, "local_dns_path")), CoroutineScope {
