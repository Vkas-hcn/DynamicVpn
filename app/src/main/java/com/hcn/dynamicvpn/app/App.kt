package com.hcn.dynamicvpn.app
...
import com.hcn.dynamicvpn.BuildConfig
...
import com.hcn.dynamicvpn.ui.guide.GuideActivity
...
//            }
    ...
    fun onStopState() {
        job_og = GlobalScope.launch {
            ...
            ActivityUtils.finishActivity(GuideActivity::class.java)
        }
    }
    ...
    private fun jumpGuidePageDynamic() {
        whetherBackgroundDynamic = false
        warmBoot = true
        val intent = Intent(top_activity_og, GuideActivity::class.java)
